...
export default function SideElements() {
  return (
    <>
      ...
      <div className="side-element side-left" data-aos="fade-up" data-aos-delay="1000">
      ...
      {/* Dominio - Lado Derecho */}
      <div className="side-element side-right" data-aos="fade-up" data-aos-delay="1000">
        <div className="domain-container">
          <a href="https://ivangauto.dev" target="_blank" rel="noreferrer" className="domain-text">
            ivangauto.dev
          </a>
        </div>
        <div className="vertical-line"></div>
