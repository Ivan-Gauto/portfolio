...
const row1 = [
  ...
  { name: "CodeIgniter", src: "https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/codeigniter/codeigniter-plain-wordmark.svg" }
];
...
export default function TechCarousel() {
  return (
    <div className="container my-5 py-4">
      <h1 data-aos="fade-right" data-aos-delay="400" className="text-white text-center mb-5">Herramientas</h1>
      
      <div className="carousel-container mx-auto" data-aos="fade-up" data-aos-delay="150">
